 ...
 *
 * @param <T> The type of the field that this {@link OptionHandler} works with.
 *
...
public abstract class OptionHandler<T> {
   ...
   *
   * @return The number of arguments consumed. For example, return 0 if this option doesn't take any
   *         parameter.
   */
