 ...
 * </p>
 * <p>
 * <h1>How it works:</h1> Example for parameter -s, which is String[] type:<br>
 * java -jar aaa.jar -s banan hruska jablko<br>
 * java -jar aaa.jar -s banan "hruska jablko"<br>
 * java -jar aaa.jar -s "banan hruska jablko"<br>
 * java -jar aaa.jar -s banan hruska jablko -l 4 -r<br>
 * java -jar aaa.jar -t 222 -s banan hruska jablko -r<br>
 * <br>
 * It will handle all of these posibilites. This OptionHandler scans for parameter which begins with
 * "-". If it found it, it will stop.
 * </p>
 *
...
public class StringArrayOptionHandler extends OptionHandler<String[]> {
  ...
  public StringArrayOptionHandler(
