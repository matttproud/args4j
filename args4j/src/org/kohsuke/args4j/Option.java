 ...
 *
 * <p>
 * This annotation can be placed on a field of type T or the method of the form <tt>void
 * <i>methodName</i>(T value)</tt>. Its access modified can be anything, but if it's not public,
 ...
 * <h2>Enum Switch</h2>
 * <p>
 * When T is derived from {@link Enum}, it represents an option that takes an operand, which must be
 * one of the enum constant. The comparion between the operand and the enum constant name is done in
 ...
 *
 * <pre>enum Coin { PENNY,NICKEL,DIME,QUARTER } * * class Option { * &#64;Option(name="-coin") * public Coin coin; * } * </pre>
 *
 * <h2>File Switch</h2>
 * <p>
...
public @interface Option {
  ...
  /**
   * Whether the option is multi-valued. For mappings to List<...>, this defaults to true, otherwise
   * false
   */
